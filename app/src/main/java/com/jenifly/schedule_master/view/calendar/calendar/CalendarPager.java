...
public abstract class CalendarPager extends ViewPager {
    ...
    public CalendarPager(Context context, AttributeSet attrs) {
        ...
        Attrs.solarTextSize = ta.getDimension(R.styleable.NCalendar_solarTextSize, ScreenUtils.sp2px(context, 18));
        Attrs.lunarTextSize = ta.getDimension(R.styleable.NCalendar_lunarTextSize, ScreenUtils.sp2px(context, 10));
        Attrs.selectCircleRadius = ta.getDimension(R.styleable.NCalendar_selectCircleRadius, ScreenUtils.dp2px(context, 20));

        Attrs.isShowLunar = ta.getBoolean(R.styleable.NCalendar_isShowLunar, true);

        Attrs.pointSize = ta.getDimension(R.styleable.NCalendar_pointSize, (int) ScreenUtils.dp2px(context, 2));
        ...
        Attrs.hollowCircleStroke = ta.getDimension(R.styleable.NCalendar_hollowCircleStroke, ScreenUtils.dp2px(context, 1));


        Attrs.monthCalendarHeight = (int) ta.getDimension(R.styleable.NCalendar_calendarHeight, ScreenUtils.dp2px(context, 260));
        Attrs.duration = ta.getInt(R.styleable.NCalendar_duration, 300);
        ...
        Attrs.backgroundColor = ta.getColor(R.styleable.NCalendar_backgroundColor, getResources().getColor(R.color.bgCalenderCenter));
