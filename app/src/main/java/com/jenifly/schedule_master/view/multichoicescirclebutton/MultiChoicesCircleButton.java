...
import com.jenifly.schedule_master.utils.DrawableUtils;
...
public class MultiChoicesCircleButton extends View {
    ...
    private void calculateRotateMatrix(float eventX, float eventY) {
        ...
        final float rotateX = offsetY / size * 30;
        final float rotateY = -offsetX / size * 30;
        mCamera.save();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // Draw circle
        mPaint.setAlpha(255);
        mPaint.setColor(Color.parseColor("#265422"));
        ...
        if (text != null && text.length() != 0) {
            ...
            mPaint.setColor(Color.parseColor("#220482"));
        ...
        if (!mItems.isEmpty()) {
            ...
            for (int i = 0; i < mItems.size(); i++) {
                ...
                if (item.icon != null) {
                    Drawable drawable = DrawableUtils.TintDrawable(item.icon, Color.parseColor("#276321"));
